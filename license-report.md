...
│  ├─ publisher: Rick van Lieshout
│  ├─ email: info@rickvanlieshout.com
│  ├─ path: G:\ZTU\Стандарт і документ\СІД_Лаб1\untitled\node_modules\react-cookie-consent
│  └─ licenseFile: G:\ZTU\Стандарт і документ\СІД_Лаб1\untitled\node_modules\react-cookie-consent\LICENSE
...
│  ├─ licenses: MIT
│  ├─ repository: https://github.com/mathiasbynens/String.prototype.includes
│  ├─ publisher: Mathias Bynens
│  ├─ url: https://mathiasbynens.be/
...
│  └─ noticeFile: G:\ZTU\Стандарт і документ\СІД_Лаб1\untitled\node_modules\swagger-ui-dist\NOTICE
...
│  ├─ private: true
│  ├─ path: G:\ZTU\Стандарт і документ\СІД_Лаб1\untitled
│  └─ licenseFile: G:\ZTU\Стандарт і документ\СІД_Лаб1\untitled\LICENSE.md
├─ upath@1.2.0
│  ├─ licenses: MIT
